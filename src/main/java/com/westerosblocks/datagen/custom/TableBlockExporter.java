...
public class TableBlockExporter {
        ...
        /**
         * Registers a custom table block with separate textures for all 6 sides
         */
        public static void registerCustomTableBlock(BlockStateModelGenerator generator, Block block,
                        String... texturePaths) {
                ...
                // Even when 6 textures are provided, the custom Blockbench parents use a single
                // key "1"
                TextureKey KEY1 = TextureKey.of("1");
                TextureMap textureMap = new TextureMap()
                                .put(KEY1, Identifier.of(WesterosBlocks.MOD_ID,
                                                "block/" + filledTextures[0]));
