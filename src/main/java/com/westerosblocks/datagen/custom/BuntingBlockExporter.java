...
public class BuntingBlockExporter extends BaseBlockExporter {
    ...
    public static void registerBuntingBlock(BlockStateModelGenerator generator, Block block, BlockDefinition definition) {
        ...
        BlockStateVariantMap<WeightedVariant> wallVariants = BlockStateVariantMap.models(Properties.HORIZONTAL_FACING)
        ...
        generator.blockStateCollector.accept(
                VariantsBlockModelDefinitionCreator.of(block).with(wallVariants)
        );
        ...
        BlockStateVariantMap<WeightedVariant> ceilingVariants = BlockStateVariantMap.models(Properties.HORIZONTAL_FACING)
        ...
        generator.blockStateCollector.accept(
                VariantsBlockModelDefinitionCreator.of(ceilingBlock).with(ceilingVariants)
        );
    }
}
