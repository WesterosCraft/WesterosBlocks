...
public class FurnaceBlockModelHandler extends ModelExport {
    ...
    public FurnaceBlockModelHandler(BlockStateModelGenerator generator, Block block, WesterosBlockDef def) {
