...
public class LeavesBlockModelHandler extends ModelExport {
    private final BlockStateModelGenerator generator;
    private final Block block;
    private final WesterosBlockDef def;

    public LeavesBlockModelHandler(BlockStateModelGenerator generator, Block block, WesterosBlockDef def) {
