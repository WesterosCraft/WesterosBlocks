...
public class DynamicArrowSlitModelProvider {
    private static final String TEXTURE_KEY = "side";
    ...
    private static JsonObject createBottomLedge() {
        ...
        JsonObject faces = new JsonObject();
        faces.add("north", createFace(6, 15, 10, 16, true));
        faces.add("south", createFace(6, 15, 10, 16, true));
    ...
    private static JsonObject createTopLedge() {
        ...
        JsonObject faces = new JsonObject();
        faces.add("north", createFace(6, 0, 10, 1, true));
        faces.add("south", createFace(6, 0, 10, 1, true));
