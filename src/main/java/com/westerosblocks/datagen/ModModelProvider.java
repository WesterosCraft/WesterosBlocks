...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator bsmg) {
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.APPLE_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_apple", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.APPLE_CRATE)
                .randomTexture("crate_block/side_bot1", "crate_block/crate_top_apples", "crate_block/side_bot1")
                .randomTexture("crate_block/side_bot2", "crate_block/crate_top_apples", "crate_block/side_bot2")
                .randomTexture("crate_block/side_bot3", "crate_block/crate_top_apples", "crate_block/side_bot3")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.BERRY_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_berry", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.BERRY_CRATE)
                .randomTexture("crate_block/side_bot1", "crate_block/crate_top_berry", "crate_block/side_bot1")
                .randomTexture("crate_block/side_bot2", "crate_block/crate_top_berry", "crate_block/side_bot2")
                .randomTexture("crate_block/side_bot3", "crate_block/crate_top_berry", "crate_block/side_bot3").build();
        registerCustomSolidBlock(bsmg, ModBlocks.APRICOT_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_apricot", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.BLACK_BRICK_ENGRAVED).texture("ashlar_engraved/black/all").build();
        registerCustomSolidBlock(bsmg, ModBlocks.BLUEGREEN_CARVED_SANDSTONE).texture("bluegreen_carved_sandstone/side")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.BOOKSHELF_ABANDONED)
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_abandoned/side1")
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_abandoned/side2").build();
        registerCustomSolidBlock(bsmg, ModBlocks.BOOKSHELF_LIBRARY)
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_library/side1")
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_library/side2")
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_library/side3").build();
        registerCustomSolidBlock(bsmg, ModBlocks.BOOKSHELF_MAESTER)
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_maester/side1")
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_maester/side2")
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_maester/side3")
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_maester/side4")
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_maester/side5")
                .randomTexture("bench_block/spruce_top", "bench_block/spruce_top", "bookshelf_maester/side6").build();
        registerCustomSolidBlock(bsmg, ModBlocks.BROKEN_CABINET)
                .textures("cabinet/top_bottom", "cabinet/top_bottom", "bench_block/cabinet_broken").build();
        registerCustomSolidBlock(bsmg, ModBlocks.BROWN_GREY_BRICK_ENGRAVED).texture("ashlar_engraved/brown_grey/all")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.CABINET_DRAWER)
                ...
                .randomTexture("cabinet/top_bottom", "cabinet/top_bottom", "cabinet/drawer/side2").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.CARROT_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_carrot", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.CARROT_CRATE)
                .randomTexture("crate_block/side_bot1", "crate_block/crate_top_carrot", "crate_block/side_bot1")
                .randomTexture("crate_block/side_bot2", "crate_block/crate_top_carrot", "crate_block/side_bot2")
                .randomTexture("crate_block/side_bot3", "crate_block/crate_top_carrot", "crate_block/side_bot3")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.COARSE_RED_CARVED_SANDSTONE).texture("ashlar_engraved/pale_red/all")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.COBBLE_KEYSTONE).textures("cobblestone/grey/keystone/top_bottom",
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.CRATE2)
                .randomTexture("crate_block/side_bot1", "crate_block/crate_side_crossbar_left", "crate_block/side_bot1")
                .randomTexture("crate_block/side_bot2", "crate_block/crate_side_crossbar_left", "crate_block/side_bot2")
                .randomTexture("crate_block/side_bot3", "crate_block/crate_side_crossbar_left", "crate_block/side_bot3")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.CRATE3)
                ...
                .randomTexture("crate_block/side_bot3", "crate_block/crate_side_crossbar_crossed",
                        "crate_block/side_bot3")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.DARK_GREY_BRICK_ENGRAVED).texture("ashlar_engraved/dark_grey/all")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.DATE_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_dates", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.DATES).textures("dates/bottom", "dates/top", "dates/side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.DESERT_SANDSTONE_ENGRAVED).texture("ashlar_engraved/sandstone/all")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.EMPTY_BARREL)
                .randomTexture("barrel_closed/barrel_top_closed", "crate_block/barrel_top_empty", "barrel_sides/side0")
                .randomTexture("barrel_closed/barrel_top_closed", "crate_block/barrel_top_empty", "barrel_sides/side1")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.FAITH_CARVED_ARBOR_BRICK).texture("ashlar_third/arbor/faith_carved")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.FAITH_CARVED_BLACK_BRICK).texture("ashlar_quarter/black/faith_carved")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.FAITH_CARVED_DUN_BRICK).texture("ashlar_third/dun/faith_carved")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.FAITH_CARVED_GREY_BRICK).texture("ashlar_third/grey/faith_carved")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.FAITH_CARVED_STONE_BRICK).texture("ashlar_half/white/faith_carved")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.FISH_BARREL)
                .randomTexture("barrel_closed/barrel_top_closed", "crate_block/barrel_top_fish", "barrel_sides/side0")
                .randomTexture("barrel_closed/barrel_top_closed", "crate_block/barrel_top_fish", "barrel_sides/side1")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.FISH_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_fish", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.FISH_TRAP).randomTexture("fish_trap/side1")
                .randomTexture("fish_trap/side2").randomTexture("fish_trap/side3").randomTexture("fish_trap/side4")
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.GRAIN_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_grain", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.GRAIN_CRATE)
                .randomTexture("crate_block/side_bot1", "crate_block/crate_top_grain", "crate_block/side_bot1")
                .randomTexture("crate_block/side_bot2", "crate_block/crate_top_grain", "crate_block/side_bot2")
                .randomTexture("crate_block/side_bot3", "crate_block/crate_top_grain", "crate_block/side_bot3").build();
        registerCustomSolidBlock(bsmg, ModBlocks.GREEN_GREY_BRICK_ENGRAVED).texture("ashlar_engraved/green_grey/all")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.HOP_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_hop", "crate_block/basket_side").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.IRON_CRATE)
                .randomTexture("crate_block/side_bot1", "crate_block/crate_top_iron", "crate_block/side_bot1")
                .randomTexture("crate_block/side_bot2", "crate_block/crate_top_iron", "crate_block/side_bot2")
                .randomTexture("crate_block/side_bot3", "crate_block/crate_top_iron", "crate_block/side_bot3").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.LAVENDER_BASKET)
                ...
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.LAVENDER_CRATE).textures("crate_block/crate_side_crossbar_right",
                "crate_block/crate_lavender", "crate_block/crate_side_crossbar_crossed").build();
        registerCustomSolidBlock(bsmg, ModBlocks.LEMON_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_lemons", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.LIGHT_GREY_BRICK_ENGRAVED).texture("ashlar_engraved/light_grey/all")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.LIGHT_GREY_STONE_WHITE_PLASTER)
                .textures("fieldstone/grey/all", "fieldstone/grey/all", "plaster/smooth/white/all").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.LIME_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_limes", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.LOW_CLASS_UTILITY_BLOCK).texture("utility_block/lowclass").build();
        registerCustomSolidBlock(bsmg, ModBlocks.MIDDLE_CLASS_UTILITY_BLOCK).texture("utility_block/middleclass")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.OLIVE_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_olives", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.OPEN_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_top", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.OPEN_CRATE)
                .randomTexture("crate_block/side_bot1", "crate_block/crate_top_empty", "crate_block/side_bot1")
                .randomTexture("crate_block/side_bot2", "crate_block/crate_top_empty", "crate_block/side_bot2")
                .randomTexture("crate_block/side_bot3", "crate_block/crate_top_empty", "crate_block/side_bot3").build();
        registerCustomSolidBlock(bsmg, ModBlocks.ORANGE_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_oranges", "crate_block/basket_side").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.ORANGE_BRICK_ROWLOCK)
                ...
                .randomTexture("brick/orange/all1", "brick/orange/all1", "brick/orange/rowlock2").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.PINK_SANDSTONE_ENGRAVED).texture("ashlar_engraved/sandy_pink/all")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.PURPLE_GRAPE_BASKET)
                ...
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.PURPLE_GRAPE_CRATE).textures("crate_block/crate_side_crossbar_right",
                "crate_block/crate_top_grape_purple", "crate_block/crate_side_crossbar_crossed").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.REACH_OAK_WOOD_PANELLING)
                ...
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.REDORANGE_CARVED_SANDSTONE).texture("redorange_carved_sandstone/side")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.SALT_CRATE)
                .randomTexture("crate_block/side_bot1", "crate_block/crate_top_salt", "crate_block/side_bot1")
                .randomTexture("crate_block/side_bot2", "crate_block/crate_top_salt", "crate_block/side_bot2")
                .randomTexture("crate_block/side_bot3", "crate_block/crate_top_salt", "crate_block/side_bot3").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.SILVER_TIN_CRATE).textures("crate_block/crate_side_crossbar_right",
                "crate_block/crate_top_tin", "crate_block/crate_side_crossbar_crossed").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.SOURLEAF_BASKET)
                ...
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.SOURLEAF_CRATE).textures("crate_block/crate_side_crossbar_right",
                "crate_block/crate_sourleaf", "crate_block/crate_side_crossbar_crossed").build();
        registerCustomSolidBlock(bsmg, ModBlocks.SOUTHERN_BRICK_ARCH_FLAT)
                .textures("brick/southern/all1", "brick/southern/all1", "brick/southern/arch_flat").build();
        registerCustomSolidBlock(bsmg, ModBlocks.SOUTHERN_BRICK_ARCH)
                .textures("brick/southern/all1", "brick/southern/all1", "brick/southern/arch_flat").build();
        registerCustomSolidBlock(bsmg, ModBlocks.SOUTHERN_BRICK_LINTEL)
                .textures("brick/southern/all1", "brick/southern/all1", "brick/southern/lintel").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.STACKED_BONES_SOLID).textures("stacked_bones/bone_stacked_front",
                "stacked_bones/bone_stacked_front", "stacked_bones/bone_stacked_rotated").build();
        registerCustomSolidBlock(bsmg, ModBlocks.STORMLANDS_BRICK_ENGRAVED).texture("ashlar_engraved/stormlands/all")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.TABLE_DRAWERS)
                .textures("bench_block/spruce_top", "bench_block/table_top", "bench_block/table_drawers_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.THICK_GRASS_BLOCK).randomTexture("grass_block/forest_top1")
                .randomTexture("grass_block/forest_top2").randomTexture("grass_block/forest_top3").build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.TURNIP_BASKET)
                .textures("crate_block/basket_bottom", "crate_block/basket_turnip", "crate_block/basket_side").build();
        registerCustomSolidBlock(bsmg, ModBlocks.TURNIP_CRATE)
                .randomTexture("crate_block/side_bot1", "crate_block/crate_top_turnip", "crate_block/side_bot1")
                .randomTexture("crate_block/side_bot2", "crate_block/crate_top_turnip", "crate_block/side_bot2")
                .randomTexture("crate_block/side_bot3", "crate_block/crate_top_turnip", "crate_block/side_bot3")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.UNUSED_BROWN_PLASTER)
                .textures("ashlar_quarter_rounded/light_brown/all", "ashlar_quarter_rounded/light_brown/all",
                        "plaster/smooth/brown_white/all")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.UNUSED_PURPLE_PLASTER).textures("ashlar_quarter_rounded/dark_red/all",
                "ashlar_quarter_rounded/dark_red/all", "plaster/smooth/brown_white/all").build();
        registerCustomSolidBlock(bsmg, ModBlocks.VIVID_DARK_SANDSTONE_ENGRAVED).texture("ashlar_engraved/dark_tan/all")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.WATER_BARREL)
                .randomTexture("barrel_closed/barrel_top_closed", "crate_block/barrel_top_water", "barrel_sides/side0")
                .randomTexture("barrel_closed/barrel_top_closed", "crate_block/barrel_top_water", "barrel_sides/side1")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.WHITE_GRAPE_BASKET)
                ...
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.WHITE_GRAPE_CRATE).textures("crate_block/crate_side_crossbar_right",
                "crate_block/crate_top_grape_white", "crate_block/crate_side_crossbar_crossed").build();
        registerCustomSolidBlock(bsmg, ModBlocks.WINTERFELL_CARVING).texture("ashlar_third/dark_grey/carving/side")
                .build();
        ...
        registerCustomSolidBlock(bsmg, ModBlocks.TIMBER_NORTHERN_BLUE_BRESSUMMER)
                .state("plaster/smooth/gulltown_blue/all", "wood/northern/all", "plaster/smooth/gulltown_blue/all")
                .state("plaster/smooth/light_blue/all", "wood/northern/all", "plaster/smooth/light_blue/all")
                .state("plaster/smooth/blue/all", "wood/northern/all", "plaster/smooth/blue/all")
                .state("plaster/rough/gulltown_blue/all1", "wood/northern/all", "plaster/rough/gulltown_blue/all1")
                .state("plaster/wattle/gulltown_blue/all", "wood/northern/all", "plaster/wattle/gulltown_blue/all")
                .build();
        registerCustomSolidBlock(bsmg, ModBlocks.TIMBER_NORTHERN_GREEN_LEFTHATCH)
                .state("plaster/smooth/gulltown_green/all", "wood/northern/all", "plaster/smooth/gulltown_green/all")
                ...
                .state("plaster/rough/gulltown_green/all1", "wood/northern/all", "plaster/rough/gulltown_green/all1")
                .state("plaster/wattle/gulltown_green/all", "wood/northern/all", "plaster/wattle/gulltown_green/all")
                .build();

        // Log Blocks
        registerCustomLogBlock(bsmg, ModBlocks.ARCHERY_TARGET).textures("archery_target/side", "archery_target/front")
                .build();

        // Slab Blocks
        registerCustomSlabBlock(bsmg, ModBlocks.APPLE_BASKET_SLAB)
                .textures("crate_block/basket_bottom", "crate_block/basket_apple", "crate_block/basket_side_slab")
                .build();
    }
