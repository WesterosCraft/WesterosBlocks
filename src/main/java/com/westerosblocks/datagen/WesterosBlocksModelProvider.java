...
public class WesterosBlocksModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        Block[] customBlocks = ModBlocks.getCustomBlocks();
        WesterosBlocks.LOGGER.info(Arrays.toString(customBlocks));
//        for (Block customBlock : customBlocks) {
//            if (customBlock == null) continue;
//
//            switch (customBlock..blockType.toLowerCase()) {
//                case "cube":
//                    generateCubeModel(blockStateModelGenerator, blockDef);
//                    break;
//                case "stairs":
//                    generateStairsModel(blockStateModelGenerator, blockDef);
//                    break;
//                case "wall":
//                    generateWallModel(blockStateModelGenerator, blockDef);
//                    break;
//                // Add more cases as needed
//                default:
//                    LOGGER.warn("Unknown block type: " + blockDef.blockType + " for block " + blockDef.blockName);
//            }
//        }
