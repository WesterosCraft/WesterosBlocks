...
public class WCWebBlock extends WCBaseBlock {
     ...
     */
    public WCWebBlock(AbstractBlock.Settings settings) {
     ...
     */
    public WCWebBlock(AbstractBlock.Settings settings, String blockName, String creativeTab) {
