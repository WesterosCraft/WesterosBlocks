 ...
 */
public class StandaloneWCFanBlock extends Block implements Waterloggable {
     ...
     */
    public StandaloneWCFanBlock(AbstractBlock.Settings settings, Block wallBlock, 
            ...
            if (direction.getAxis().isHorizontal()) {
                ...
                if (world.getBlockState(attachPos).isSideSolidFullSquare(world, attachPos, direction)) {
                    return this.wallBlock.getDefaultState()
                            .with(StandaloneWCWallFanBlock.FACING, direction)
                            .with(StandaloneWCWallFanBlock.WATERLOGGED, fluidState.isIn(FluidTags.WATER));
                }
            }
        }
