 ...
 */
public class StandaloneFlowerPotBlock extends FlowerPotBlock {
     ...
     */
    public StandaloneFlowerPotBlock(Block content, AbstractBlock.Settings settings) {
     ...
     * @param settings The block settings
     */
    public StandaloneFlowerPotBlock(AbstractBlock.Settings settings) {
