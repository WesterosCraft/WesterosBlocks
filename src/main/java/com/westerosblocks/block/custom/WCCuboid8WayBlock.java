...
public class WCCuboid8WayBlock extends WCCuboidBlock implements ModBlockLifecycle {
    public static class Factory extends ModBlockFactory {
        ...
        public Block buildBlockClass(ModBlock def) {
            ...
            Block blk = new WCCuboid8WayBlock(settings, def);
    ...
    protected WCCuboid8WayBlock(AbstractBlock.Settings settings, ModBlock def) {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        int dir = MathHelper.floor((double) (ctx.getPlayerYaw() * 8.0F / 360.0F) + 0.5D) & 7;
