...
public class OldWCPlantBlock extends Block implements ModBlockLifecycle {
    ...
    public static class Factory extends ModBlockFactory {
        ...
        public Block buildBlockClass(ModBlock def) {
            ...
            Block blk = new OldWCPlantBlock(settings, def);
    ...
    protected OldWCPlantBlock(AbstractBlock.Settings settings, ModBlock def) {
        super(settings);
        this.def = def;
        String t = def.getType();
        if (t != null) {
