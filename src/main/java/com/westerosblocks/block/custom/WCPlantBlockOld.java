...
public class WCPlantBlockOld extends Block implements ModBlockLifecycle {
    ...
    public static class Factory extends ModBlockFactory {
        ...
        public Block buildBlockClass(ModBlock def) {
            ...
            Block blk = new WCPlantBlockOld(settings, def);
    ...
    protected WCPlantBlockOld(AbstractBlock.Settings settings, ModBlock def) {
        super(settings);
        this.def = def;
        String t = def.getType();
        if (t != null) {
