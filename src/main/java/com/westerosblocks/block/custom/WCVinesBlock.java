...
public class WCVinesBlock extends VineBlock implements WesterosBlockLifecycle {
    ...
    private static final VoxelShape DOWN_AABB = VoxelShapes.cuboid(0.0D, 0.0D, 0.0D, 16.0D, 1.0D, 16.0D);
    private static final VoxelShape WEST_AABB = VoxelShapes.cuboid(0.0D, 0.0D, 0.0D, 1.0D, 16.0D, 16.0D);
    private static final VoxelShape EAST_AABB = VoxelShapes.cuboid(15.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D);
    private static final VoxelShape NORTH_AABB = VoxelShapes.cuboid(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 1.0D);
    private static final VoxelShape SOUTH_AABB = VoxelShapes.cuboid(0.0D, 0.0D, 15.0D, 16.0D, 16.0D, 16.0D);
