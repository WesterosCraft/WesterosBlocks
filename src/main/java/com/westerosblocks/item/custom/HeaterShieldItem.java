...
public class HeaterShieldItem extends ModShieldItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final int cooldownTicks;
    private final Item repairItem;
    private final String path;

    public HeaterShieldItem(Settings settings, int cooldownTicks, int enchantability, Item repairItems, String path) {
...
//    }
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private HeaterShieldRenderer renderer;

            @Override
            public BuiltinModelItemRenderer getGeoItemRenderer() {
                if (this.renderer == null) {

                    this.renderer = new HeaterShieldRenderer(
