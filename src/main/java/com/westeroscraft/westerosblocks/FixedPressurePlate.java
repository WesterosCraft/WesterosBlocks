...
public class FixedPressurePlate extends BlockPressurePlate {

    protected FixedPressurePlate(int blockID, String texture,
            Material material, EnumMobType mobType) {
        super(blockID, texture, material, mobType);
    }
