...
public class RenderWCFallingSand extends Render
{
     ...
     */
    public void doRenderFallingSand(EntityWCFallingSand par1EntityFallingSand, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.doRenderFallingSand((EntityWCFallingSand)par1Entity, par2, par4, par6, par8, par9);
    }
}
